...
impl TryFrom<u8> for OpKind {
    ...
    fn try_from(value: u8) -> Result<Self, Self::Error> {
        match value {
            ...
            33 => Ok(OpKind::Sext),
            34 => Ok(OpKind::Concat),
            35 => Ok(OpKind::Concat8L),
            36 => Ok(OpKind::Concat8R),
            37 => Ok(OpKind::Extract8),
            38 => Ok(OpKind::Extract),
            39 => Ok(OpKind::Deposit),
            40 => Ok(OpKind::QzExtract),
            41 => Ok(OpKind::QsExtract),
            42 => Ok(OpKind::QzExtract2),
            43 => Ok(OpKind::Ctz),
            44 => Ok(OpKind::Clz),
            45 => Ok(OpKind::Bswap),
            46 => Ok(OpKind::Rcl),
            47 => Ok(OpKind::Andc),
            48 => Ok(OpKind::Ite),
            49 => Ok(OpKind::IteEqZero),
            50 => Ok(OpKind::IteNeZero),
            51 => Ok(OpKind::Or3),
            52 => Ok(OpKind::Xor3),
            53 => Ok(OpKind::Pmovmskb),
            54 => Ok(OpKind::CmpEq),
            55 => Ok(OpKind::CmpGt),
            56 => Ok(OpKind::CmpGe),
            57 => Ok(OpKind::CmpLe),
            ...
            59 => Ok(OpKind::Min),
            60 => Ok(OpKind::Max),
            61 => Ok(OpKind::SignedSaturation),
            62 => Ok(OpKind::UnsignedSaturation),
            63 => Ok(OpKind::Nand),
            64 => Ok(OpKind::MulHigh),
            65 => Ok(OpKind::MuluHigh),
            66..=86 => Ok(match value {
            ...
            101 => Ok(OpKind::SymbolicPc),
            102 => Ok(OpKind::SymbolicJumpTableAccess),
            103 => Ok(OpKind::MemorySlice),
            104 => Ok(OpKind::MemorySliceAccess),
            105 => Ok(OpKind::MemoryInputSliceAccess),
            106 => Ok(OpKind::SymbolicLoad),
            107 => Ok(OpKind::SymbolicStore),
            108 => Ok(OpKind::MemoryConcretization),
            109 => Ok(OpKind::ConsistencyCheck),
            110 => Ok(OpKind::InputSlice),
            111 => Ok(OpKind::Mov),
            112 => Ok(OpKind::Model),
